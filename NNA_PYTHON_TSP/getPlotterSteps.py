...
cur_dir = os.getcwd()
#open txtfile
outputfile = open("output_NNA_TSP_PYTHON_STEPS.txt", "w")
for filename  in os.listdir(os.getcwd()):
#check if file is directory
    print(filename)
    if filename.endswith(".txt") and filename != "logfile.txt" and not filename.startswith("output_NNA_TSP_PYTHON") and filename != "objects.txt":
