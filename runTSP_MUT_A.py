...
for i in range(1, 21):
    try:
        os.mkdir("./TSP_MUT/A/round_" + str(i))
    except FileExistsError:
        pass
    
    print(f"ROUND {i} TSP_MUT A")
    for file_name in os.listdir("./original")[:len(os.listdir("./original"))//2]:
        ...
        TSP.write_route_gcode_to_file(shortest_route, f"./TSP_MUT/A/round_{i}/{file_name}")
        with open("./TSP_MUT/A/meta_data.txt", "a") as file:
