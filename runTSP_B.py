...
for i in range(1, 21):
    try:
        os.mkdir("./TSP_res/B/round_" + str(i))
    except FileExistsError:
        pass
    
    print(f"ROUND {i} TSP B")
    for file_name in os.listdir("./original")[len(os.listdir("./original"))//2:]:
        ...
        TSP.write_route_gcode_to_file(shortest_route, f"./TSP_res/B/round_{i}/{file_name}")
        with open("./TSP_res/B/meta_data.txt", "a") as file:
